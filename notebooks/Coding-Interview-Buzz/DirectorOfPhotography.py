# I solved it using prefix sum approach. I maintain two prefix sums for photographer and backdrop. For every actor, i'll check the number of photographers in the front and backdrops in the back and viceversa.
